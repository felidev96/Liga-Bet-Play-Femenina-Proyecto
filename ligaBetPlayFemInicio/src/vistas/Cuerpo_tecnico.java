...
public class Cuerpo_tecnico extends javax.swing.JInternalFrame implements TreeSelectionListener {
...
//        scrollPaneArea.setBounds(10,150, 400, 120);
        scrollPaneArea.setViewportView(areaDeTexto);
//        scrollPaneArea.setLocation(5, 5);
...
//        panelPrincipal.setLocation(20, 20);
	}
	...
	/*Construimos los nodos del arbol que seran ramas u hojas*/
        DefaultMutableTreeNode carpetaRaiz = new DefaultMutableTreeNode("Cuerpo Técnico");
        ...
        DefaultMutableTreeNode carpeta2 = new DefaultMutableTreeNode("Técnico");
        DefaultMutableTreeNode archivo1 = new DefaultMutableTreeNode("Albeiro Erazo");
