 ...
 * @author felip
 */
public class santafeFrame_2021 extends javax.swing.JInternalFrame {

    
    public santafeFrame_2021() {
        
        initComponents();
        this.setLocation(5, 5);
        //this.setSize(new Dimension (300, 400));
        this.setTitle("Santa fe - Liga Bet Play 2021");
    ...
    private void campeonStaf1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_campeonStaf1ActionPerformed
        ...
        try {
            ...
            Logger.getLogger(santafeFrame_2021.class.getName()).log(Level.SEVERE , null, ex);
        }
