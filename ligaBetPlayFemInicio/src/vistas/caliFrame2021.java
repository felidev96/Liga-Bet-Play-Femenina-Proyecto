 ...
 * @author felip
 */
public class caliFrame2021 extends javax.swing.JInternalFrame {

    
    public caliFrame2021() {
        
        initComponents();
        this.setLocation(5, 5);
        //this.setSize(new Dimension (300, 400));
        this.setTitle("Dep. Cali - Liga Bet Play 2021");
    ...
    private void campeonStaf1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_campeonStaf1ActionPerformed
        ...
        try {
            ...
            Logger.getLogger(caliFrame2021.class.getName()).log(Level.SEVERE , null, ex);
        }
